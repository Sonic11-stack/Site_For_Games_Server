...
async def get_game_page(request: Request, game_id: int, game_name: str, db=Depends(get_db)):
    cur = db.cursor()
    ...
    return templates.TemplateResponse(
        ...
        "date": game["date"], "description": game["description"], "developer": game["developer"], "rawg_api_key": api_key, "game_name": game_name,
